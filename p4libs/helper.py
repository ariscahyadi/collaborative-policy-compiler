...
class P4InfoHelper(object):
    ...
    def get_action_param_pb(self, action_name, param_name, value):
        ...
        p4runtime_param.value = convert.encode(value, p4info_param.bitwidth)
