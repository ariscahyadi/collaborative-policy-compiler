...
_REGISTERENTRY.fields_by_name['data'].message_type = p4data__pb2._P4DATA
...
_DIGESTLIST.fields_by_name['data'].message_type = p4data__pb2._P4DATA
...
_MASTERARBITRATIONUPDATE.fields_by_name['status'].message_type = status__pb2._STATUS
...
_FORWARDINGPIPELINECONFIG.fields_by_name['p4info'].message_type = p4info__pb2._P4INFO
